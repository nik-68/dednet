...
"reqOne = ssn.get(<a href=http://httpbin.org/cookies>http://httpbin.org/cookies</a>)"
"print(reqOne.text)"
# prints information about "visit-month" cookie
 
"reqTwo = ssn.get(<a href=http://httpbin.org/cookies>http://httpbin.org/cookies</a>, cookies={visit-year: 2017})"
"print(reqTwo.text)"
# prints information about "visit-month" and "visit-year" cookie
 
"reqThree = ssn.get(<a href=http://httpbin.org/cookies>http://httpbin.org/cookies</a>)"
"print(reqThree.text)"
# prints information about "visit-month" cookie
# Stats
sent = 0
...
while True:
    try:
        ...
        sent +=0
        print(green + f"[LOG] Loading {sent} ")
        print("DDoS")
    except OSError: 
        error +=1
